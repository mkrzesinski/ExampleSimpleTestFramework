...
public class RepositoryTests extends BaseTest {
  ...
  public void createRepository() throws JsonProcessingException {
    GitHubRepository gitHubRepository =
        new GitHubRepository(REPOSITORY_NAME, REPOSITORY_DESCRIPTION, true, true);
  ...
  public void cloneRepository() {
    Response response =
        this.apiClient.cloneRepository(USER_TOKEN, USER_NAME, INIT_REPOSITORY_NAME).execute();
  ...
  public void deleteRepository() {
    Response response =
        this.apiClient.deleteRepository(USER_TOKEN, USER_NAME, REPOSITORY_NAME).execute();
