...
public class IssueTests extends BaseTest {
  ...
  public void createAndDeleteIssue() throws JsonProcessingException {
    ...
    Response response =
        this.apiClient
            .addNewIssue(USER_TOKEN, this.requestBody, USER_NAME, INIT_REPOSITORY_NAME)
            .execute();
  ...
  public void editIssue() throws JsonProcessingException {
    ...
    Response response =
        this.apiClient
            .editIssue(USER_TOKEN, this.requestBody, USER_NAME, INIT_REPOSITORY_NAME, this.issueId)
            .execute();
